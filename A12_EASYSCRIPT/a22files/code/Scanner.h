...
typedef union TokenAttribute {
	...
	EasyScript_int intValue;				/* integer literal attribute (value) */
	EasyScript_int keywordIndex;			/* keyword index in the keyword table */
	EasyScript_int contentString;			/* string literal offset from the beginning of the string literal buffer (stringLiteralTable->content) */
	EasyScript_real floatValue;				/* floating-point literal attribute (value) */
	EasyScript_char idLexeme[VID_LEN + 1];	/* variable identifier token attribute */
	EasyScript_char errLexeme[ERR_LEN + 1];	/* error token attribite */
} TokenAttribute;
...
typedef struct idAttibutes {
	...
	union {
		...
		EasyScript_real floatValue;			/* Float value */
...
static EasyScript_int transitionTable[NUM_STATES][CHAR_CLASSES] = {
